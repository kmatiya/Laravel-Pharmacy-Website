            ...
            <div class="row">
                ...
                <div class="col-md-3 text-center animate-box">
                    <div class="product">
                        ...
                        <div class="desc">
                            <h3><a href="single.html">Antidiabetics</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 text-center animate-box">
                        <div class="product">
                            ...
                            <div class="desc">
                                <h3><a href="single.html">Nutritional  supplements</a></h3>
                            </div>
                        </div>
                    </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3 text-center animate-box">
                    <div class="product">
                        ...
                        <div class="desc">
                            <h3><a href="single.html">Diagnostic (Rapid tests, BP Machines,Glucometers etc)</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 text-center animate-box">
            ...
            <div class="row">
                    ...
                    <div class="col-md-3 text-center animate-box">
                        <div class="product">
                            ...
                            <div class="desc">
                                <h3><a href="single.html">Surgicals(spirit,bandages,gloves etc)</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 text-center animate-box">
                        <div class="product">
                            ...
                            <div class="desc">
                                <h3><a href="single.html">Eye agents</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 text-center animate-box">
                            <div class="product">
                                ...
                                <div class="desc">
                                    <h3><a href="single.html">Reproductive agents</a></h3>
                                </div>
                            </div>
                        </div>
                </div>
                <div class="row">
                        <div class="col-md-3 text-center animate-box">
                            <div class="product">
                                ...
                                <div class="desc">
                                    <h3><a href="single.html">Malaria prophylaxis</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 text-center animate-box">
                            <div class="product">
                                ...
                                <div class="desc">
                                    <h3><a href="single.html">Laboratory agents</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 text-center animate-box">
                        ...
                        <div class="col-md-3 text-center animate-box">
                                <div class="product">
                                    ...
                                    <div class="desc">
                                        <h3><a href="single.html">Antimalarials</a></h3>
                                    </div>
                                </div>
                            </div>
                    </div>
                <div class="row">
                        <div class="col-md-3 text-center animate-box">
                            <div class="product">
                                ...
                                <div class="desc">
                                    <h3><a href="single.html">Antibiotics</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 text-center animate-box">
                            <div class="product">
                                ...
                                <div class="desc">
                                    <h3><a href="single.html">Topical agents(creams ,lotions etc</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 text-center animate-box">
                            <div class="product">
                                ...
                                <div class="desc">
                                    <h3><a href="single.html">Antipsychotics</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 text-center animate-box">
                                <div class="product">
                                    ...
                                    <div class="desc">
                                        <h3><a href="single.html">First Aid Products </a></h3>
                                    </div>
                                </div>
                            </div>
                    </div>
                    <div class="row">
                            <div class="col-md-3 text-center animate-box">
                                <div class="product">
                                    ...
                                    <div class="desc">
                                        <h3><a href="single.html">Antifungals</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 text-center animate-box">
                                <div class="product">
                                    ...
                                    <div class="desc">
                                        <h3><a href="single.html">Antihypertensive</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 text-center animate-box">
